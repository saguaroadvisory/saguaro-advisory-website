  ...
  return (
    <section id="about" style={{ padding: "96px 5%", backgroundColor: "#fff" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }} className="about-grid">
        {/* Card */}
        <div style={{ backgroundColor: "#2C3A2E", borderRadius: "12px", padding: "48px 40px", color: "#F2E4C8" }}>
          ...
          {creds.map(c => (
            <div key={c} style={{ display: "flex", alignItems: "flex-start", gap: "10px", color: "rgba(242,228,200,0.6)", fontSize: "0.85rem", marginBottom: "12px", fontFamily: "'Inter',sans-serif" }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "1.0rem", color: "#5E7A60", lineHeight: 1.8, marginBottom: "32px", fontFamily: "'Inter',sans-serif", fontWeight: 300 }}>
