    ...
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "640px" }}>
        ...
        <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
          <a href="https://calendar.app.google/bsA7iCTALPAYhJUZ6" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", backgroundColor: "#7A9E7E", color: "#2C3A2E", textDecoration: "none", padding: "14px 30px", borderRadius: "4px", fontWeight: 700, fontSize: "0.95rem", letterSpacing: "0.02em", transition: "background-color 0.2s,transform 0.15s" }}
